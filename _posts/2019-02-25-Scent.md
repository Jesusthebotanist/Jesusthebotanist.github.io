...
During my undergrad I had the fantastic oppertunity to help out with Theresa Wang's (a fellow undergrad in the lab) senior thesis project. Her thesis was a collaberative project between Veronica Di Stilio and Jeff Riffel's lab to investigate the floral scent profiles between insect and wind pollinated species of Thalictrum. The manscuript was published late last year in [Annuals of Botany](https://academic.oup.com/aob/article/123/2/289/5056502) (Email me if you stuck behind paywall). 

I joined the project while I was taking [Data Science for Biologist](https://docs.wixstatic.com/ugd/b83b01_bb7ba7ff3216490eab0c86c628431108.pdf); I need a project for the course and Theresa had some data just for that! The following is a slight modificaiton from the published supplementary material found in this [github repo](https://github.com/Jesusthebotanist/Thalictrum-Floral-Scent). 


The data: Floral scent was collected and analyized with Gas chromatography-mass spectrometry from 12 species of Thalictrum to get a broad idea of the different volitie compounds emitted. In addition floral scent extract was presented to a bumble bee to get a measure of response. In this script I,

1) Test for phylogenetic signal of VOC emmited by each flower using Blomberg's K and
2) Performed an ancestral state reconstrion of electroantennogram (EAG) response
...
## Prune Tree down to 11 species with floral scent
