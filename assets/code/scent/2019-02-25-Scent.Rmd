...
We can now calculate Blombergs K with the entire dataset as a whole. Multivariate comparative methods is still a very active area of research, luckily two active  There have been two fairly recent methods use to  There are two libraries that have this implementation, Phylocurve and Geomorph. 
